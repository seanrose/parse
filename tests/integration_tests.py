...
from nose.tools import ok_, timed
...
def test_create_object():
    ...
    obj = p.create_object(TEST_CLASS)
...
def test_get_object():
    ...
    obj = p.query_object_class(TEST_CLASS, {}, first_result_only=True)

    p.get_object(TEST_CLASS, obj['objectId'])
...
def test_update_object():
    ...
    updated_at = p.update_object(TEST_CLASS, obj['objectId'], {'foo': 'bar'})
...
def test_delete_object():
    ...
    ok_(p.delete_object(TEST_CLASS, obj['objectId']),
